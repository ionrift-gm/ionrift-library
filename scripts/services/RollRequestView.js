...
/**
 * Build roll-request context for the library standalone player prompt overlay.
...
export function buildPromptRollContext(payload = {}) {
    ...
    const participants = [{
        ...
        rolled,
        total: rolled && typeof total === "number" ? total : null,
        passed: rolled && typeof passed === "boolean" ? passed : null,
        isOwner: true,
        canRoll: !rolled
    }];
