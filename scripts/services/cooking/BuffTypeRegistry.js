/**
 * Canonical IonriftBuff type registry. Each type maps a buff descriptor to
 * human-readable summary text and (on dnd5e) Active Effect changes via render().
 */
 ...
 * Effect changes plus human-readable summary text.
