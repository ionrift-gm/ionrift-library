...
function resolveRoot(root) {
    ...
    return document.querySelector("#ionrift-roll-request-preview")
        ?? document.querySelector(".ionrift-roll-request-prompt")
...
export function inspectDcAnimation(root) {
    ...
    if (!report.stageFound) {
        console.warn("Open preview first: game.ionrift.library.rollRequest.openPreview() or game.ionrift.respite.rollRequest.openPreview()");
